...
export default function Home() {
  ...
  return (
    <div className="landing w-screen h-max text-white text-center xl:ml-32 xl:mr-4 lg:mr-5 lg:ml-24  z-40" id="home">
      <div className="home flex-col  h-3/7 lg:h-2/5  justify-center " >
        <div className="heading">
          <div className="title hometitle text-white  lg:text-left font-pixelEmulator text-5xl mt-20" >
            Game Development <br />
            and <br />
        ...
        <div className="parallax-layer ship mt-10 h-96 w-screen  -translate-x-10"></div>
        <div className="content flex w-4/5 lg:flex-row xl:w-11/12   text-neutral-400 gap-6 items-center justify-center m-auto align-middle text-3xl text-center flex-col  xl:mt-20 lg:mt-5">
          {arr.map(({ title, img, link, about }) => (
            <div
              key={title}
              className=" glass contentText rounded-2xl flex flex-col justify-center h-50 xl:h-72 sm:w-1/2  xl:w-2/5  bg-gradient-to-br from-red-700 via-violet-900 to-blue-700 p-0.5"
              onClick={() => {
                const url = link;
      ...
      >
        ...
        <div className="w-3/4 h-120 md:h-60 flex flex-row justify-evenly m-auto mt-20 rounded-2xl  align-middle bg-gradient-to-br from-red-700 via-violet-900 to-blue-700 p-0.5">
          <div className="glass contentTextAbout flex flex-row justify-evenly rounded-2xl w-full align-middle bg-black">
